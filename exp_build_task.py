...
def main() -> int:
	...
	# print("Signing HVPP...")
	sign_exp("Output/Spoofy.bin", "Output/Spoofy_signed.bin", exp_id=EXP_ID)
	...
	# print("Signing HVPP...")
	sign_exp("Output/HVPP.bin", "Output/HVPP_dev_signed.bin", exp_id=EXP_ID)
	# print("Outputting HVPP...")
	...
	# print("Signing HVPP...")
	sign_exp("Output/HVPP.bin", "Output/HVPP_test_signed.bin", exp_magic=ExpansionMagic.SIGM, exp_id=EXP_ID)
	# print("Outputting HVPP...")
	...
	# assemble_patch("Patches/HVPP.S", "Output/HVPP_test.bin", PATCH_DIR)
	# print("Signing HVPP...")
	sign_exp("Output/HVPP.bin", "Output/HVPP_retail_signed.bin", encrypt=False, exp_id=EXP_ID)
	# print("Outputting HVPP...")
